...
if st.session_state.pregunta == 1:
    ...
    if st.button("Enviar", key="btn4"):
        if any(x in res for x in ["ginecologo", "doctor", "medico", "fuimos al ginecologo"]):
    ...
    if st.button("Enviar Final", key="btn11"):
